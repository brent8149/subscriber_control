#ifndef ArActionKinect_H
#define ArActionKinect_H
...
//=====================================================
class ArActionKinect : public ArAction
{
public:
    ...
    //=====================================================
AREXPORT ArActionKinect(const char * name, float *beamAngle, float *beamConfidence);

    AREXPORT virtual ~ArActionKinect();
...
private:
    ...
    //=====================================================
    void computeKinectControl(void);

};

#endif // ArActionKinect_H
