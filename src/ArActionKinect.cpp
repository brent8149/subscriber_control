...
//
//=====================================================
AREXPORT ArActionKinect::ArActionKinect(const char * name, float *beam_Angle, float *beam_Confidence): ArAction(name, "Kinect Audio Control")
{
...
AREXPORT ArActionKinect::~ArActionKinect()
{
    //dtor
}
...
//
//=====================================================
AREXPORT ArActionDesired *ArActionKinect::fire(ArActionDesired currentDesired)
{
...
void ArActionKinect::computeKinectControl()
{
    myDesiredAction.setRotVel(100* (*beamAngle* *beamConfidence));
    //myDesiredAction.setRotVel(*beamAngle);
    myDesiredAction.setVel(100.0);
}/*
void ArActionKinect::updateAriaLatency()
{
    // get the robot we're attached to, and update the local latency
    latency_aria = getRobot()->getLatency();
}*/
/*
void ArActionKinect::updateState()
{
...
/*
void ArActionKinect::computeControl()
{
